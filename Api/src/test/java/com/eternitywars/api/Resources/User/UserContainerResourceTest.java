...
class UserContainerResourceTest
{
...
//        assertEquals(expectedUserCollection.getUsers().get(0).getUsername(), userCollection.getUsers().get(0).getUsername());
//        assertEquals(expectedUserCollection.getUsers().get(1).getUsername(), userCollection.getUsers().get(1).getUsername());
    }
}